...
C - - - - - 0x02C1D1 0B:81C1: 8D 01 04  STA ram_animation_id + 1
bra_81C4_RTS:
...
C - - - - - 0x02C244 0B:8234: 9D 40 04  STA ram_object_X_pos_hi,X
C - - - - - 0x02C247 0B:8237: B9 57 83  LDA tbl_8357,Y
C - - - - - 0x02C24A 0B:823A: 9D 10 04  STA ram_object_Y_pos_hi,X
...
C - - - - - 0x02C255 0B:8245: 9D 42 04  STA ram_blow_X_pos_hi,X
C - - - - - 0x02C258 0B:8248: B9 42 83  LDA tbl_8342,Y
C - - - - - 0x02C25B 0B:824B: 9D 12 04  STA ram_blow_Y_pos_hi,X
...
C - - - - - 0x02C2B0 0B:82A0: 9D 00 04  STA ram_animation_id,X
bra_82A3:
...
C - - - - - 0x02E5A3 0B:A593: BD 40 04  LDA ram_object_X_pos_hi,X
C - - - - - 0x02E5A6 0B:A596: D9 40 04  CMP ram_object_X_pos_hi,Y
...
C - - - - - 0x02E5B1 0B:A5A1: BD 10 04  LDA ram_object_Y_pos_hi,X
...
bra_A5F8:
C - - - - - 0x02E608 0B:A5F8: BD 00 04  LDA ram_animation_id,X
...
C - - - - - 0x02E630 0B:A620: B9 42 04  LDA ram_blow_X_pos_hi,Y
C - - - - - 0x02E633 0B:A623: D0 0D     BNE bra_A632
C - - - - - 0x02E635 0B:A625: B9 44 04  LDA ram_special_X_pos_hi,Y
...
bra_A632:
C - - - - - 0x02E642 0B:A632: DD 40 04  CMP ram_object_X_pos_hi,X
...
C - - - - - 0x02E64E 0B:A63E: BC 00 04  LDY ram_animation_id,X
...
bra_A654:
C - - - - - 0x02E664 0B:A654: B9 12 04  LDA ram_blow_Y_pos_hi,Y
C - - - - - 0x02E667 0B:A657: D0 0D     BNE bra_A666
C - - - - - 0x02E669 0B:A659: B9 14 04  LDA ram_special_Y_pos_hi,Y
...
bra_A666:
C - - - - - 0x02E676 0B:A666: BC 00 04  LDY ram_animation_id,X
C - - - - - 0x02E679 0B:A669: 38        SEC
C - - - - - 0x02E67A 0B:A66A: FD 10 04  SBC ram_object_Y_pos_hi,X
...
C - - - - - 0x02E6EB 0B:A6DB: B9 10 04  LDA ram_object_Y_pos_hi,Y
...
C - - - - - 0x02E736 0B:A726: B9 10 04  LDA ram_object_Y_pos_hi,Y
...
C - - - - - 0x02E7DE 0B:A7CE: B9 50 05  LDA ram_object_id,Y
...
C - - - - - 0x02E834 0B:A824: B9 50 05  LDA ram_object_id,Y
...
C - - - - - 0x02E888 0B:A878: BC 50 05  LDY ram_object_id,X
C - - - - - 0x02E88B 0B:A87B: B9 9C A8  LDA tbl_A89C,Y
C - - - - - 0x02E88E 0B:A87E: D0 06     BNE bra_A886
bra_A880:
C - - - - - 0x02E890 0B:A880: BC 50 05  LDY ram_object_id,X
...
bra_AA6F:
C - - - - - 0x02EA7F 0B:AA6F: 8D 50 05  STA ram_object_id
C - - - - - 0x02EA82 0B:AA72: 8A        TXA
C - - - - - 0x02EA83 0B:AA73: 49 01     EOR #$01
C - - - - - 0x02EA85 0B:AA75: AA        TAX
C - - - - - 0x02EA86 0B:AA76: AD 50 05  LDA ram_object_id
...
C - - - - - 0x02EB1A 0B:AB0A: B9 50 05  LDA ram_object_id,Y
C - - - - - 0x02EB1D 0B:AB0D: 0A        ASL
C - - - - - 0x02EB1E 0B:AB0E: 0A        ASL
C - - - - - 0x02EB1F 0B:AB0F: 0A        ASL
C - - - - - 0x02EB20 0B:AB10: 38        SEC
C - - - - - 0x02EB21 0B:AB11: F9 50 05  SBC ram_object_id,Y
C - - - - - 0x02EB24 0B:AB14: 18        CLC
C - - - - - 0x02EB25 0B:AB15: 7D 50 05  ADC ram_object_id,X
...
C - - - - - 0x02FDEE 0B:BDDE: 8D 00 04  STA ram_animation_id
C - - - - - 0x02FDF1 0B:BDE1: B9 7D BD  LDA tbl_BD7D,Y
C - - - - - 0x02FDF4 0B:BDE4: 8D 01 04  STA ram_animation_id + 1
...
bra_BF3F:
C - - - - - 0x02FF4F 0B:BF3F: 9D 00 04  STA ram_animation_id,X
