...
- D 0 - - - 0x028010 0A:8000: 04        .byte $04   ; 
...
; bzk мусор неиспользуемые анимации
- - - - - - 0x02BBAE 0A:BB9E: B8 BB     .word off_BBB8_00
- - - - - - 0x02BBB0 0A:BBA0: D1 BB     .word off_BBD1_01
- - - - - - 0x02BBB2 0A:BBA2: D9 BB     .word off_BBD9_02
- - - - - - 0x02BBB4 0A:BBA4: E1 BB     .word off_BBE1_03
- - - - - - 0x02BBB6 0A:BBA6: E9 BB     .word off_BBE9_04
- - - - - - 0x02BBB8 0A:BBA8: 02 BC     .word off_BC02_05
- - - - - - 0x02BBBA 0A:BBAA: 1B BC     .word off_BC1B_06
- - - - - - 0x02BBBC 0A:BBAC: 33 BC     .word off_BC33_07
- - - - - - 0x02BBBE 0A:BBAE: 3F BC     .word off_BC3F_08
- - - - - - 0x02BBC0 0A:BBB0: 58 BC     .word off_BC58_09
- - - - - - 0x02BBC2 0A:BBB2: 23 BC     .word off_BC23_0A
- - - - - - 0x02BBC4 0A:BBB4: 2B BC     .word off_BC2B_0B
- - - - - - 0x02BBC6 0A:BBB6: 79 BC     .word off_BC79_0C
...
ofs_BBB9:
- - - - - - 0x02BBC9 0A:BBB9: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBCA 0A:BBBA: C2        .byte con_T + $C2   ; 
- - - - - - 0x02BBCB 0A:BBBB: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBCC 0A:BBBC: 00        .byte con_X + $00   ; 

- - - - - - 0x02BBCD 0A:BBBD: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBCE 0A:BBBE: C4        .byte con_T + $C4   ; 
- - - - - - 0x02BBCF 0A:BBBF: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBD0 0A:BBC0: 08        .byte con_X + $08   ; 

- - - - - - 0x02BBD1 0A:BBC1: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBD2 0A:BBC2: C6        .byte con_T + $C6   ; 
- - - - - - 0x02BBD3 0A:BBC3: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBD4 0A:BBC4: 10        .byte con_X + $10   ; 

- - - - - - 0x02BBD5 0A:BBC5: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBD6 0A:BBC6: C8        .byte con_T + $C8   ; 
- - - - - - 0x02BBD7 0A:BBC7: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBD8 0A:BBC8: 18        .byte con_X + $18   ; 

- - - - - - 0x02BBD9 0A:BBC9: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBDA 0A:BBCA: CA        .byte con_T + $CA   ; 
- - - - - - 0x02BBDB 0A:BBCB: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBDC 0A:BBCC: 20        .byte con_X + $20   ; 

- - - - - - 0x02BBDD 0A:BBCD: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBDE 0A:BBCE: CC        .byte con_T + $CC   ; 
- - - - - - 0x02BBDF 0A:BBCF: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBE0 0A:BBD0: 28        .byte con_X + $28   ; 
...
- - - - - - 0x02BBE2 0A:BBD2: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBE3 0A:BBD3: CE        .byte con_T + $CE   ; 
- - - - - - 0x02BBE4 0A:BBD4: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBE5 0A:BBD5: 28        .byte con_X + $28   ; 

- - - - - - 0x02BBE6 0A:BBD6: 80        .byte $80   ; 
- - - - - - 0x02BBE7 0A:BBD7: B9 BB     .word ofs_BBB9
...
- - - - - - 0x02BBEA 0A:BBDA: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBEB 0A:BBDB: D0        .byte con_T + $D0   ; 
- - - - - - 0x02BBEC 0A:BBDC: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBED 0A:BBDD: 28        .byte con_X + $28   ; 

- - - - - - 0x02BBEE 0A:BBDE: 80        .byte $80   ; 
- - - - - - 0x02BBEF 0A:BBDF: B9 BB     .word ofs_BBB9
...
- - - - - - 0x02BBF2 0A:BBE2: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBF3 0A:BBE3: D2        .byte con_T + $D2   ; 
- - - - - - 0x02BBF4 0A:BBE4: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBF5 0A:BBE5: 28        .byte con_X + $28   ; 

- - - - - - 0x02BBF6 0A:BBE6: 80        .byte $80   ; 
- - - - - - 0x02BBF7 0A:BBE7: B9 BB     .word ofs_BBB9
...
- - - - - - 0x02BBFA 0A:BBEA: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBFB 0A:BBEB: D4        .byte con_T + $D4   ; 
- - - - - - 0x02BBFC 0A:BBEC: 02        .byte con_A + $02   ; 
- - - - - - 0x02BBFD 0A:BBED: 00        .byte con_X + $00   ; 

- - - - - - 0x02BBFE 0A:BBEE: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BBFF 0A:BBEF: D6        .byte con_T + $D6   ; 
- - - - - - 0x02BC00 0A:BBF0: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC01 0A:BBF1: 08        .byte con_X + $08   ; 

- - - - - - 0x02BC02 0A:BBF2: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC03 0A:BBF3: D8        .byte con_T + $D8   ; 
- - - - - - 0x02BC04 0A:BBF4: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC05 0A:BBF5: 10        .byte con_X + $10   ; 

- - - - - - 0x02BC06 0A:BBF6: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC07 0A:BBF7: DA        .byte con_T + $DA   ; 
- - - - - - 0x02BC08 0A:BBF8: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC09 0A:BBF9: 18        .byte con_X + $18   ; 

- - - - - - 0x02BC0A 0A:BBFA: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC0B 0A:BBFB: DC        .byte con_T + $DC   ; 
- - - - - - 0x02BC0C 0A:BBFC: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC0D 0A:BBFD: 20        .byte con_X + $20   ; 

- - - - - - 0x02BC0E 0A:BBFE: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC0F 0A:BBFF: DE        .byte con_T + $DE   ; 
- - - - - - 0x02BC10 0A:BC00: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC11 0A:BC01: 28        .byte con_X + $28   ; 
...
- - - - - - 0x02BC13 0A:BC03: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC14 0A:BC04: CC        .byte con_T + $CC   ; 
- - - - - - 0x02BC15 0A:BC05: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC16 0A:BC06: 08        .byte con_X + $08   ; 

ofs_BC07:
- - - - - - 0x02BC17 0A:BC07: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC18 0A:BC08: E0        .byte con_T + $E0   ; 
- - - - - - 0x02BC19 0A:BC09: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC1A 0A:BC0A: 10        .byte con_X + $10   ; 

ofs_BC0B:
- - - - - - 0x02BC1B 0A:BC0B: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC1C 0A:BC0C: FE        .byte con_T + $FE   ; 
- - - - - - 0x02BC1D 0A:BC0D: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC1E 0A:BC0E: 00        .byte con_X + $00   ; 

- - - - - - 0x02BC1F 0A:BC0F: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC20 0A:BC10: E6        .byte con_T + $E6   ; 
- - - - - - 0x02BC21 0A:BC11: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC22 0A:BC12: 18        .byte con_X + $18   ; 

- - - - - - 0x02BC23 0A:BC13: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC24 0A:BC14: E8        .byte con_T + $E8   ; 
- - - - - - 0x02BC25 0A:BC15: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC26 0A:BC16: 20        .byte con_X + $20   ; 

- - - - - - 0x02BC27 0A:BC17: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC28 0A:BC18: EA        .byte con_T + $EA   ; 
- - - - - - 0x02BC29 0A:BC19: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC2A 0A:BC1A: 28        .byte con_X + $28   ; 
...
- - - - - - 0x02BC2C 0A:BC1C: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC2D 0A:BC1D: CE        .byte con_T + $CE   ; 
- - - - - - 0x02BC2E 0A:BC1E: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC2F 0A:BC1F: 08        .byte con_X + $08   ; 

- - - - - - 0x02BC30 0A:BC20: 80        .byte $80   ; 
- - - - - - 0x02BC31 0A:BC21: 07 BC     .word ofs_BC07
...
- - - - - - 0x02BC34 0A:BC24: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC35 0A:BC25: D0        .byte con_T + $D0   ; 
- - - - - - 0x02BC36 0A:BC26: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC37 0A:BC27: 08        .byte con_X + $08   ; 

- - - - - - 0x02BC38 0A:BC28: 80        .byte $80   ; 
- - - - - - 0x02BC39 0A:BC29: 07 BC     .word ofs_BC07
...
- - - - - - 0x02BC3C 0A:BC2C: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC3D 0A:BC2D: D2        .byte con_T + $D2   ; 
- - - - - - 0x02BC3E 0A:BC2E: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC3F 0A:BC2F: 08        .byte con_X + $08   ; 

- - - - - - 0x02BC40 0A:BC30: 80        .byte $80   ; 
- - - - - - 0x02BC41 0A:BC31: 07 BC     .word ofs_BC07
...
- - - - - - 0x02BC44 0A:BC34: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC45 0A:BC35: E2        .byte con_T + $E2   ; 
- - - - - - 0x02BC46 0A:BC36: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC47 0A:BC37: 08        .byte con_X + $08   ; 

- - - - - - 0x02BC48 0A:BC38: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC49 0A:BC39: E4        .byte con_T + $E4   ; 
- - - - - - 0x02BC4A 0A:BC3A: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC4B 0A:BC3B: 10        .byte con_X + $10   ; 

- - - - - - 0x02BC4C 0A:BC3C: 80        .byte $80   ; 
- - - - - - 0x02BC4D 0A:BC3D: 0B BC     .word ofs_BC0B
...
- - - - - - 0x02BC50 0A:BC40: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC51 0A:BC41: FE        .byte con_T + $FE   ; 
- - - - - - 0x02BC52 0A:BC42: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC53 0A:BC43: 00        .byte con_X + $00   ; 

- - - - - - 0x02BC54 0A:BC44: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC55 0A:BC45: EC        .byte con_T + $EC   ; 
- - - - - - 0x02BC56 0A:BC46: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC57 0A:BC47: 08        .byte con_X + $08   ; 

- - - - - - 0x02BC58 0A:BC48: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC59 0A:BC49: EE        .byte con_T + $EE   ; 
- - - - - - 0x02BC5A 0A:BC4A: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC5B 0A:BC4B: 10        .byte con_X + $10   ; 

- - - - - - 0x02BC5C 0A:BC4C: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC5D 0A:BC4D: F0        .byte con_T + $F0   ; 
- - - - - - 0x02BC5E 0A:BC4E: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC5F 0A:BC4F: 18        .byte con_X + $18   ; 

- - - - - - 0x02BC60 0A:BC50: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC61 0A:BC51: F2        .byte con_T + $F2   ; 
- - - - - - 0x02BC62 0A:BC52: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC63 0A:BC53: 20        .byte con_X + $20   ; 

- - - - - - 0x02BC64 0A:BC54: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC65 0A:BC55: FE        .byte con_T + $FE   ; 
- - - - - - 0x02BC66 0A:BC56: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC67 0A:BC57: 28        .byte con_X + $28   ; 
...
- - - - - - 0x02BC69 0A:BC59: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC6A 0A:BC5A: EC        .byte con_T + $EC   ; 
- - - - - - 0x02BC6B 0A:BC5B: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC6C 0A:BC5C: 00        .byte con_X + $00   ; 

- - - - - - 0x02BC6D 0A:BC5D: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC6E 0A:BC5E: C4        .byte con_T + $C4   ; 
- - - - - - 0x02BC6F 0A:BC5F: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC70 0A:BC60: 08        .byte con_X + $08   ; 

- - - - - - 0x02BC71 0A:BC61: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC72 0A:BC62: C6        .byte con_T + $C6   ; 
- - - - - - 0x02BC73 0A:BC63: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC74 0A:BC64: 10        .byte con_X + $10   ; 

- - - - - - 0x02BC75 0A:BC65: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC76 0A:BC66: F4        .byte con_T + $F4   ; 
- - - - - - 0x02BC77 0A:BC67: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC78 0A:BC68: 18        .byte con_X + $18   ; 

- - - - - - 0x02BC79 0A:BC69: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC7A 0A:BC6A: F6        .byte con_T + $F6   ; 
- - - - - - 0x02BC7B 0A:BC6B: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC7C 0A:BC6C: 20        .byte con_X + $20   ; 

- - - - - - 0x02BC7D 0A:BC6D: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC7E 0A:BC6E: F8        .byte con_T + $F8   ; 
- - - - - - 0x02BC7F 0A:BC6F: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC80 0A:BC70: 28        .byte con_X + $28   ; 

- - - - - - 0x02BC81 0A:BC71: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC82 0A:BC72: FA        .byte con_T + $FA   ; 
- - - - - - 0x02BC83 0A:BC73: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC84 0A:BC74: 30        .byte con_X + $30   ; 

- - - - - - 0x02BC85 0A:BC75: 00        .byte con_Y + $00   ; 
- - - - - - 0x02BC86 0A:BC76: FC        .byte con_T + $FC   ; 
- - - - - - 0x02BC87 0A:BC77: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC88 0A:BC78: 38        .byte con_X + $38   ; 
...
- - - - - - 0x02BC8A 0A:BC7A: 09        .byte con_Y + $09   ; 
- - - - - - 0x02BC8B 0A:BC7B: 6F        .byte con_T + $6F   ; 
- - - - - - 0x02BC8C 0A:BC7C: 03        .byte con_A + $03   ; 
- - - - - - 0x02BC8D 0A:BC7D: F8        .byte con_X + $F8   ; 

- - - - - - 0x02BC8E 0A:BC7E: 09        .byte con_Y + $09   ; 
- - - - - - 0x02BC8F 0A:BC7F: 6F        .byte con_T + $6F   ; 
- - - - - - 0x02BC90 0A:BC80: 43        .byte con_A + $43   ; 
- - - - - - 0x02BC91 0A:BC81: 00        .byte con_X + $00   ; 

- - - - - - 0x02BC92 0A:BC82: E9        .byte con_Y + $E9   ; 
- - - - - - 0x02BC93 0A:BC83: 67        .byte con_T + $67   ; 
- - - - - - 0x02BC94 0A:BC84: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC95 0A:BC85: F4        .byte con_X + $F4   ; 

- - - - - - 0x02BC96 0A:BC86: E9        .byte con_Y + $E9   ; 
- - - - - - 0x02BC97 0A:BC87: 69        .byte con_T + $69   ; 
- - - - - - 0x02BC98 0A:BC88: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC99 0A:BC89: FC        .byte con_X + $FC   ; 

- - - - - - 0x02BC9A 0A:BC8A: F9        .byte con_Y + $F9   ; 
- - - - - - 0x02BC9B 0A:BC8B: 6B        .byte con_T + $6B   ; 
- - - - - - 0x02BC9C 0A:BC8C: 02        .byte con_A + $02   ; 
- - - - - - 0x02BC9D 0A:BC8D: F4        .byte con_X + $F4   ; 

- - - - - - 0x02BC9E 0A:BC8E: F9        .byte con_Y + $F9   ; 
- - - - - - 0x02BC9F 0A:BC8F: 6D        .byte con_T + $6D   ; 
- - - - - - 0x02BCA0 0A:BC90: 02        .byte con_A + $02   ; 
- - - - - - 0x02BCA1 0A:BC91: FC        .byte con_X + $FC   ; 

- - - - - - 0x02BCA2 0A:BC92: E9        .byte con_Y + $E9   ; 
- - - - - - 0x02BCA3 0A:BC93: 67        .byte con_T + $67   ; 
- - - - - - 0x02BCA4 0A:BC94: 42        .byte con_A + $42   ; 
- - - - - - 0x02BCA5 0A:BC95: 04        .byte con_X + $04   ; 

- - - - - - 0x02BCA6 0A:BC96: F9        .byte con_Y + $F9   ; 
- - - - - - 0x02BCA7 0A:BC97: 6B        .byte con_T + $6B   ; 
- - - - - - 0x02BCA8 0A:BC98: 42        .byte con_A + $42   ; 
- - - - - - 0x02BCA9 0A:BC99: 04        .byte con_X + $04   ; 
