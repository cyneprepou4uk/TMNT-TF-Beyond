...
.export sub_0x03D21C
sub_0x03D21C:
C - - - - - 0x03D21C 0F:D20C: BD 40 04  LDA ram_object_X_pos,X
...
C - - - - - 0x03D23C 0F:D22C: BD 40 04  LDA ram_object_X_pos,X
C - - - - - 0x03D23F 0F:D22F: D9 40 04  CMP ram_object_X_pos,Y
...
C - - - - - 0x03D772 0F:D762: BC 10 04  LDY ram_object_Y_pos,X
...
C - - - - - 0x03D784 0F:D774: BC 40 04  LDY ram_object_X_pos,X
...
C - - - - - 0x03DAED 0F:DADD: 9D 40 04  STA ram_object_X_pos,X
C - - - - - 0x03DAF0 0F:DAE0: 9D 10 04  STA ram_object_Y_pos,X
...
bra_DB5E:
C - - - - - 0x03DB6E 0F:DB5E: 7D 10 04  ADC ram_object_Y_pos,X
C - - - - - 0x03DB71 0F:DB61: 9D 10 04  STA ram_object_Y_pos,X
...
bra_DB77:
C - - - - - 0x03DB87 0F:DB77: 7D 40 04  ADC ram_object_X_pos,X
C - - - - - 0x03DB8A 0F:DB7A: 9D 40 04  STA ram_object_X_pos,X
...
C - - - - - 0x03DBCB 0F:DBBB: BD 40 04  LDA ram_object_X_pos,X
C - - - - - 0x03DBCE 0F:DBBE: 99 40 04  STA ram_object_X_pos,Y
...
C - - - - - 0x03DBDD 0F:DBCD: BD 10 04  LDA ram_object_Y_pos,X
C - - - - - 0x03DBE0 0F:DBD0: 99 10 04  STA ram_object_Y_pos,Y
...
C - - - - - 0x03DC80 0F:DC70: DD 10 04  CMP ram_object_Y_pos,X
...
C - - - - - 0x03DC8F 0F:DC7F: DD 10 04  CMP ram_object_Y_pos,X
C - - - - - 0x03DC92 0F:DC82: B0 0C     BCS bra_DC90
bra_DC84:
C - - - - - 0x03DC94 0F:DC84: A9 B0     LDA #$B0
C - - - - - 0x03DC96 0F:DC86: 9D 10 04  STA ram_object_Y_pos,X
...
C - - - - - 0x03DCFF 0F:DCEF: DD 10 04  CMP ram_object_Y_pos,X
C - - - - - 0x03DD02 0F:DCF2: B0 03     BCS bra_DCF7_RTS
C - - - - - 0x03DD04 0F:DCF4: 9D 10 04  STA ram_object_Y_pos,X
bra_DCF7_RTS:
...
.export sub_0x03DD14
sub_0x03DD14:
C - - - - - 0x03DD14 0F:DD04: BD 40 04  LDA ram_object_X_pos,X
...
C - - - - - 0x03DEE9 0F:DED9: B9 40 04  LDA ram_object_X_pos,Y
C - - - - - 0x03DEEC 0F:DEDC: 99 4C 04  STA ram_044C,Y
C - - - - - 0x03DEEF 0F:DEDF: B9 10 04  LDA ram_object_Y_pos,Y
...
C - - - - - 0x03DF0D 0F:DEFD: DD 40 04  CMP ram_object_X_pos,X
C - - - - - 0x03DF10 0F:DF00: 90 07     BCC bra_DF09
C - - - - - 0x03DF12 0F:DF02: A9 18     LDA #$18
C - - - - - 0x03DF14 0F:DF04: DD 40 04  CMP ram_object_X_pos,X
C - - - - - 0x03DF17 0F:DF07: 90 03     BCC bra_DF0C_RTS
bra_DF09:
C - - - - - 0x03DF19 0F:DF09: 9D 40 04  STA ram_object_X_pos,X
bra_DF0C_RTS:
...
.export sub_0x03DF1D
sub_0x03DF1D:
C - - - - - 0x03DF1D 0F:DF0D: DD 10 04  CMP ram_object_Y_pos,X
...
C - - - - - 0x03E366 0F:E356: 8D 40 04  STA ram_object_X_pos
...
C - - - - - 0x03E378 0F:E368: 8D 41 04  STA ram_object_X_pos + 1
...
C - - - - - 0x03E385 0F:E375: 8D 10 04  STA ram_object_Y_pos
C - - - - - 0x03E388 0F:E378: A9 8F     LDA #$8F
C - - - - - 0x03E38A 0F:E37A: 8D 11 04  STA ram_object_Y_pos + 1
...
C - - - - - 0x03E398 0F:E388: 8D 41 04  STA ram_object_X_pos + 1
bra_E38B_RTS:
...
C - - - - - 0x03E439 0F:E429: 9D 40 04  STA ram_object_X_pos,X
C - - - - - 0x03E43C 0F:E42C: A9 B0     LDA #$B0
C - - - - - 0x03E43E 0F:E42E: 9D 10 04  STA ram_object_Y_pos,X
...
C - - - - - 0x03E518 0F:E508: CD 10 04  CMP ram_object_Y_pos
C - - - - - 0x03E51B 0F:E50B: B0 E5     BCS bra_E4F2
C - - - - - 0x03E51D 0F:E50D: CD 11 04  CMP ram_object_Y_pos + 1
...
C - - - - - 0x03E803 0F:E7F3: 8D 40 04  STA ram_object_X_pos
C - - - - - 0x03E806 0F:E7F6: A9 B0     LDA #$B0
C - - - - - 0x03E808 0F:E7F8: 8D 10 04  STA ram_object_Y_pos
...
C - - - - - 0x03E854 0F:E844: AD 10 04  LDA ram_object_Y_pos
...
C - - - - - 0x03E8E8 0F:E8D8: 8D 10 04  STA ram_object_Y_pos
C - - - - - 0x03E8EB 0F:E8DB: A9 60     LDA #$60
C - - - - - 0x03E8ED 0F:E8DD: 8D 40 04  STA ram_object_X_pos
...
C - - - - - 0x03E9D3 0F:E9C3: BD 40 04  LDA ram_object_X_pos,X
...
C - - - - - 0x03E9E7 0F:E9D7: B9 40 04  LDA ram_object_X_pos,Y
...
C - - - - - 0x03E9F5 0F:E9E5: FD 40 04  SBC ram_object_X_pos,X
...
C - - - - - 0x03EA00 0F:E9F0: B9 40 04  LDA ram_object_X_pos,Y
...
.export sub_0x03ECE9
sub_0x03ECE9:
C - - - - - 0x03ECE9 0F:ECD9: BD 40 04  LDA ram_object_X_pos,X
...
C - - - - - 0x03ECFF 0F:ECEF: DD 40 04  CMP ram_object_X_pos,X
C - - - - - 0x03ED02 0F:ECF2: 60        RTS
bra_ECF3:
C - - - - - 0x03ED03 0F:ECF3: BD 40 04  LDA ram_object_X_pos,X
...
sub_EE97:
C - - - - - 0x03EEA7 0F:EE97: B9 40 04  LDA ram_object_X_pos,Y
C - - - - - 0x03EEAA 0F:EE9A: 38        SEC
C - - - - - 0x03EEAB 0F:EE9B: FD 40 04  SBC ram_object_X_pos,X
...
.export sub_0x03EEB9
sub_0x03EEB9:
C - - - - - 0x03EEB9 0F:EEA9: B9 10 04  LDA ram_object_Y_pos,Y
C - - - - - 0x03EEBC 0F:EEAC: 38        SEC
C - - - - - 0x03EEBD 0F:EEAD: FD 10 04  SBC ram_object_Y_pos,X
...
C - - - - - 0x03EF8A 0F:EF7A: BD 40 04  LDA ram_object_X_pos,X
C - - - - - 0x03EF8D 0F:EF7D: D9 40 04  CMP ram_object_X_pos,Y
...
C - - - - - 0x03F457 0F:F447: 8D 40 04  STA ram_object_X_pos
...
C - - - - - 0x03F46A 0F:F45A: 8D 10 04  STA ram_object_Y_pos
bra_F45D_RTS:
...
C - - - - - 0x03FDAB 0F:FD9B: BC 10 04  LDY ram_object_Y_pos,X
C - - - - - 0x03FDAE 0F:FD9E: C0 B0     CPY #$B0
C - - - - - 0x03FDB0 0F:FDA0: B0 02     BCS bra_FDA4
C - - - - - 0x03FDB2 0F:FDA2: A9 19     LDA #$19
bra_FDA4:
C - - - - - 0x03FDB4 0F:FDA4: DD 40 04  CMP ram_object_X_pos,X
C - - - - - 0x03FDB7 0F:FDA7: 90 08     BCC bra_FDB1
C - - - - - 0x03FDB9 0F:FDA9: 9D 40 04  STA ram_object_X_pos,X
...
C - - - - - 0x03FDE5 0F:FDD5: DD 10 04  CMP ram_object_Y_pos,X
C - - - - - 0x03FDE8 0F:FDD8: B0 03     BCS bra_FDDD
C - - - - - 0x03FDEA 0F:FDDA: 9D 10 04  STA ram_object_Y_pos,X
bra_FDDD:
...
bra_FE22:
C - - - - - 0x03FE32 0F:FE22: BD 40 04  LDA ram_object_X_pos,X
C - - - - - 0x03FE35 0F:FE25: ED 3C 06  SBC ram_063C
C - - - - - 0x03FE38 0F:FE28: 9D 40 04  STA ram_object_X_pos,X
...
C - - - - - 0x03FEB3 0F:FEA3: B9 10 04  LDA ram_object_Y_pos,Y
